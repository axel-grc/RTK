...
def build_parser():
    # Argument parsing
    parser = rtk.rtk_argument_parser(description="Creates an RTK geometry file from simulated/regular trajectory. See https://docs.openrtk.org/en/latest/documentation/docs/Geometry.html for more information.")
