...
AddNoiseFromGgo(typename TImageType::Pointer projections, const TArgsInfo & args_info)
{
  ...
  {
    const double I0{ args_info.poisson_arg[0] };
    double       muref{ 0.01879 }; // mm^-1, attenuation coefficient of water at 75 keV
    if (args_info.poisson_given > 1)
      muref = args_info.poisson_arg[1];
